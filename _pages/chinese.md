...
本人博士期间主要关注以**深度学习求解偏微分方程**，同时也对以下方向感兴趣：
- 凸优化
- 深度学习应用
- 偏微分方程数值解
- **量化交易**

主要课题为利用深度学习加速偏微分方程传统数值的求解速度（主要为波动方程）。

## 📚 所修课程

### 本科课程
**数学基础**：数学分析、代数学基础、线性代数、实分析、微分方程、复分析、泛函分析、近世代数

**应用数学**：数据结构与数据库、组合学、概率论、数理统计、随机过程、运筹学、数值代数
...
### 博士课程
算法分析与设计 • 高等数值分析 • 大数据和计算 • 机器学习基础 • 有限元方法 • 现代优化方法 • 差分方法 • 反问题理论及应用 • 深度学习
