...
**My personal interest is to explore market rules in a quantitative way**.

During my time at Tsinghua University, my research interests focused on **Deep Learning for solving partial differential equations**, with additional work in:
- Convex Optimization
- Deep Learning Applications
- Numerical Solutions for PDEs
- **Quantitative Trading**

My main research goal was to leverage deep learning to accelerate traditional numerical methods for solving partial differential equations.

## 📚 Academic Background

### Undergraduate Courses
**Mathematics Foundation**: Mathematical Analysis, Algebra, Linear Algebra, Real Analysis, Differential Equations, Complex Analysis, Functional Analysis, Modern Algebra

**Applied Mathematics**: Data Structure & Database, Combinatorics, Probability Theory, Mathematical Statistics, Stochastic Process, Numerical Algebra, Operations Research

**Interdisciplinary**: Management Science, Economics

*All mathematics courses achieved top grades*

### Ph.D. Courses
Algorithm Analysis and Design • Advanced Numerical Analysis • Big Data and Computing • Fundamentals of Machine Learning • Finite Element Methods • Modern Optimization Methods • Difference Methods • Inverse Problem Theory and Applications • Deep Learning
